...
1. **Clonar e Subir o Ambiente:**
   ```bash
   git clone https://github.com/MarceloStos/SGS_Sistema_de_Gestao_de_Solicitacoes.git
...
**Pré-requisitos:** Java 17 e PostgreSQL (versão 16 ou superior) instalados localmente.
